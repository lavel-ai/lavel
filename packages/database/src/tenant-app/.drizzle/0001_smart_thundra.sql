...
--> statement-breakpoint
CREATE TABLE "main"."component_settings" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "component_settings_user_id_component_id_instance_id_pk" PRIMARY KEY("user_id","component_id","instance_id")
);
--> statement-breakpoint
...
ALTER TABLE "main"."component_settings" ADD CONSTRAINT "component_settings_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "main"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "main"."kpi_order" ADD CONSTRAINT "kpi_order_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "main"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
